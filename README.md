...
Then open **http://127.0.0.1:8321**, or run `bento setup` for the same twelve steps in a terminal.
...
## Setup is twelve steps, and each one leaves something behind
...
![The first-run setup screen: the rail of setup steps down the left, and on the right "Name your agent" with the line "You will end up with: the name on the menu bar and in every reply"](docs/screenshots/onboarding-1-name.png)
...
![The Setup app in a window: the rail of setup steps on the left, and the "Build a specialist" step open on the right](docs/screenshots/setup-app.png)
