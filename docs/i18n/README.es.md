...
> **Aviso:** esta traducción fue generada por IA y aún no ha sido revisada por una persona; puede contener errores. Si algo no coincide, la [versión en inglés](../../README.md) es la que vale.
...
## El primer día pesa menos que la cuarta semana

El escritorio se abría con 43 iconos en una máquina que todavía no podía responder una pregunta. Ahora:

![El escritorio el primer día: tres grupos abiertos, tres plegados en una línea con un contador, y en la barra de menú el chip «Aún sin cerebro · dale uno»](../design/ux-review/after/a-desktop.jpg)

- **El deck pliega lo que aún no has usado.** Intelligence, System y Library empiezan como una línea con un contador y una muestra de sus iconos; se despliegan con un clic, o la primera vez que abres una de sus apps. Un deck que tú has ordenado se queda exactamente como lo dejaste.
- **La barra de menú dice en qué estado está la máquina.** Si no hay nada configurado para responder, muestra *Aún sin cerebro · dale uno →*, y al pulsarlo se abre ese paso de la configuración.
- **Un turno fallido es una frase con una puerta.** Sin modelo, Ollama apagado, una clave rechazada, un límite de peticiones, un modelo sin descargar: cada uno es una frase y un botón (*Dale un cerebro*, *Abrir proveedores de IA*, *Abrir Model Manager*), en el Chat, en la tarjeta de la barra de entrada y en cada panel copiloto. El nombre de la excepción va a los Logs, que es donde debe estar.
- **Una regla para cada ventana emergente.** El lanzador, los menús, las notificaciones, energía y Ajustes rápidos se abren de uno en uno, se cierran con Escape y con un clic fuera, y el lanzador cabe en la pantalla en la que está.
- **En el teléfono, un solo cuadro de escritura.** Una hoja con su propia entrada oculta la barra de entrada; las apps de lista/detalle muestran un panel cada vez con un camino de vuelta; el asistente de configuración conserva su salida.

![El primer mensaje en una instalación nueva: «Nada puede responder todavía — esta máquina no tiene cerebro» con un botón «Dale un cerebro», en lugar de una excepción de Python](../design/ux-review/after/a-chat-sent.jpg)

Cada uno de estos puntos se midió en un navegador real antes y después. La revisión que los encontró, con las cifras: [docs/design/ux-review-2026-09.md](../design/ux-review-2026-09.md).
