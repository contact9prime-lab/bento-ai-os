...
![Bento Box AI in motion — asking the agent for a morning briefing and getting a live reply, stacking windows, and switching between five design languages](../screenshots/demo.gif)

<sub>▶ [पूरी क्लिप देखें (MP4)](../screenshots/demo.mp4) — एक वास्तविक टर्न जिसका जवाब डिवाइस पर ही दिया गया; ऊपर दिखाया गया चैट रिप्लाई लाइव एजेंट है, कोई मॉकअप नहीं।</sub>
...
वहाँ नहीं था — बाद में एक नया टर्मिनल खोलें)।
...
|---|---|
| `--passphrase=SECRET` | sign in करने के लिए इसकी ज़रूरत हो, और loopback से बाहर binding की अनुमति दे |
...
| `--yes` | हर वैकल्पिक कंपोनेंट को हाँ में जवाब दें |
...
> सिर्फ़ `127.0.0.1` पर सुनता है जब तक आप इसे एक passphrase न दें, क्योंकि एजेंट के पास एक असली शेल है — यहाँ एक खुला
> पोर्ट एक खुला शेल है। इसी वजह से अकेले `--bind` अस्वीकार किया जाता है, और वैसे ही
> remote access बंद होने पर `bento serve --host 0.0.0.0` भी।
