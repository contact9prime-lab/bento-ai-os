...
> **सूचना:** यह अनुवाद AI द्वारा तैयार किया गया है और अभी किसी व्यक्ति ने इसकी जाँच नहीं की है; इसमें गलतियाँ हो सकती हैं। कोई अंतर होने पर [अंग्रेज़ी संस्करण](../../README.md) ही मान्य है।
...
## सेटअप बारह कदमों का है, और हर एक कुछ पीछे छोड़ जाता है
...
## पहला दिन चौथे हफ़्ते से हल्का है

पहले डेस्कटॉप ऐसी मशीन पर 43 टाइलों के साथ खुलता था जो अभी एक सवाल का जवाब भी नहीं दे सकती थी। अब:

![पहले दिन का डेस्कटॉप: तीन समूह खुले, तीन गिनती के साथ एक पंक्ति में सिमटे हुए, और मेनू बार में "अभी दिमाग़ नहीं है · इसे एक दें" की चिप](../design/ux-review/after/a-desktop.jpg)

- **डेक उन चीज़ों को समेट देता है जिन्हें आपने अभी इस्तेमाल नहीं किया।** Intelligence, System और Library गिनती और आइकनों की झलक वाली एक पंक्ति से शुरू होते हैं; एक क्लिक पर, या जब आप पहली बार उनका कोई ऐप खोलते हैं, तब खुल जाते हैं। जो डेक आपने ख़ुद सजाया है वह ठीक वैसा ही रहता है जैसा आपने छोड़ा था।
- **मेनू बार बताता है कि मशीन किस हाल में है।** अगर जवाब देने के लिए कुछ सेट नहीं है तो वहाँ *अभी दिमाग़ नहीं है · इसे एक दें →* लिखा दिखता है, और क्लिक करने पर सेटअप का वही कदम खुलता है।
- **असफल हुई बारी एक वाक्य है जिसमें एक दरवाज़ा है।** कोई मॉडल नहीं, Ollama नहीं चल रहा, कुंजी ठुकरा दी गई, रेट लिमिट, मॉडल डाउनलोड नहीं हुआ — हर एक एक वाक्य और एक बटन है (*इसे दिमाग़ दें*, *AI प्रदाता खोलें*, *Model Manager खोलें*), चैट में, प्रॉम्प्ट बार के कार्ड में और हर कोपायलट पैनल में। एक्सेप्शन का नाम लॉग में जाता है, जहाँ उसकी जगह है।
- **हर पॉपओवर के लिए एक नियम।** लॉन्चर, मेनू, सूचनाएँ, पावर और त्वरित सेटिंग्स एक बार में एक ही खुलते हैं, Escape और बाहर क्लिक करने पर बंद होते हैं, और लॉन्चर उसी स्क्रीन में समा जाता है जिस पर वह है।
- **फ़ोन पर सिर्फ़ एक इनपुट बॉक्स।** अपने इनपुट वाली शीट प्रॉम्प्ट बार को छिपा देती है; सूची/विवरण वाले ऐप एक बार में एक ही पैनल दिखाते हैं और वापस लौटने का रास्ता देते हैं; सेटअप विज़ार्ड में बाहर निकलने का रास्ता बना रहता है।

![नई इंस्टॉल पर पहला संदेश: Python एक्सेप्शन की जगह "अभी कोई जवाब नहीं दे सकता — इस मशीन में दिमाग़ नहीं है" और "इसे दिमाग़ दें" बटन](../design/ux-review/after/a-chat-sent.jpg)

इनमें से हर एक को असली ब्राउज़र में पहले और बाद में मापा गया। जिस समीक्षा ने इन्हें खोजा, वह आँकड़ों समेत [docs/design/ux-review-2026-09.md](../design/ux-review-2026-09.md) में है।
...
फिर **http://127.0.0.1:8321** खोलें, या टर्मिनल में उन्हीं बारह कदमों के लिए `bento setup` चलाएँ।
